...
import pepeHeart from '@/assets/images/pepeHeart.jpg';
import pepeThoughtOf from '@/assets/images/pepeThought.jpg';
  ...
  return `
    ...
    <main class="main">
      ...
      <section class="about-section">
        ...
        ${AboutBlock(reverseOrder, aboutParagraphs.siteStructureFirst, aboutParagraphs.siteStructureSecond, pepeThoughtOf)}
        ${AboutBlock(normalOrder, aboutParagraphs.myWishesFirst, aboutParagraphs.myWishesSecond, pepeHeart)}
      </section>
      ${SectionDivider(motivationPhrases)}
    </main>
